...
; 0000 0078 // D4 - PORTC Bit 3
; 0000 0079 // D5 - PORTC Bit 4
; 0000 007A // D6 - PORTC Bit 5
; 0000 007B // D7 - PORTC Bit 6
; 0000 007C // Characters/line: 8
; 0000 007D lcd_init(8);
	LDI  R26,LOW(8)
	RCALL _lcd_init
; 0000 007E 
; 0000 007F while (1)
_0x3:
; 0000 0080       {
; 0000 0081       lcd_puts("Hello world!");
	__POINTW2MN _0x6,0
	RCALL _lcd_puts
